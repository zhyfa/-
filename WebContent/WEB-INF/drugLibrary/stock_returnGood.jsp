		...
		<tbody>
			<c:forEach items="${requestScope.stocks }" var="stock" varStatus="st">
				...
				<tr class="active">
					...
					<td width="150">
						<button onclick="returnGood(${stock.stock_id },${stock.drug_id },${stock.stock_number },${stock.factory_id })" ${stock.state!=1?'hidden':'' }>退货申请</button>
...
<script type="text/javascript">
	function returnGood(stock_id,drug_id,stock_number,factory_id) {
		if(confirm("确认退货嘛？")){
			$.ajax({
				type : "post",
				...
				dataType : "JSON",
				data : {"stock_id":stock_id,"drug_id":drug_id,"stock_number":stock_number,"factory_id":factory_id},
