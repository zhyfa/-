...
<table id="tb1">
	<tr>
	<td id="td1">药房报损</td>
	<td id="td2"><a class="layui-btn" href="<%=basePath%>/daily/badDrugList.action"> <i class="layui-icon">&#xe63c;</i>报损详情</a></td>
	</tr>
</table>
	...
	<tbody>
		<c:forEach items="${requestScope.inventorys }" var="inventory" varStatus="st">
			...
			<tr class="danger">
				...
				<td>
					<button class="layui-btn layui-btn-xs layui-btn-danger" onclick="returnBack(${inventory.drug_id })"> <i class="layui-icon">&#xe69c;</i>报损</button>
				</td>
			</tr>
		</c:forEach>
	</tbody>
